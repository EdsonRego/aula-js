...
console.log(compararPorTamanho("Anabele", "João"));
console.log(compararPorTamanho("João", "Anabele"));
console.log(compararPorTamanho("João", "João"));
